...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row justify-content-center">
        ...
        <div class="row flex-column align-items-start m-4">
    ...
    <div class="row justify-content-center">
        <div class="row" id="messagePlaceholder">
            <asp:Button runat="server" ID="btnReserve" CssClass="btn btn-lg btn-outline-primary" OnClick="HandlerReserveBook" />
        </div>
    </div>
